...
class fsk_python_embd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._f_c_range_win = RangeWidget(self._f_c_range_range, self.set_f_c_range, 'f_c_range', "counter_slider", float)
        self.top_grid_layout.addWidget(self._f_c_range_win)
        self._div_range_range = Range(500, 10000, 1, 500, 200)
        self._div_range_win = RangeWidget(self._div_range_range, self.set_div_range, 'div_range', "counter_slider", float)
    ...
    def get_f_c_range(self):
        return self.f_c_range

    def set_f_c_range(self, f_c_range):
        self.f_c_range = f_c_range
        self.epy_block_0.f_c = self.f_c_range

    def get_div_range(self):
        return self.div_range

    def set_div_range(self, div_range):
        self.div_range = div_range
        self.epy_block_0.diviation = self.div_range



def main(top_block_cls=fsk_python_embd, options=None):
