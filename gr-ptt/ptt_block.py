...
class ptt_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.range1 = range1 = 0

        ##################################################
        # Blocks
        ##################################################
        self._range1_range = Range(0, 1, 1, 0, 200)
        self._range1_win = RangeWidget(self._range1_range, self.set_range1, 'kalit', "counter_slider", float)
    ...
    def set_range1(self, range1):
        self.range1 = range1
        self.blocks_multiply_const_vxx_0.set_k(self.range1)
