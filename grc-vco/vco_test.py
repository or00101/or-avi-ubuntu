...
class vco_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "VCO Cali")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("VCO Cali")
        ...
        self.const_range = const_range = 0
...
def main(top_block_cls=vco_test, options=None):
